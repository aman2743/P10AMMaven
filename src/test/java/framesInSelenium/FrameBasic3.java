...
public class FrameBasic3 {
	...
	Thread.sleep(2000);
	js.executeScript("document.getElementById('name').value='Currently inside frame3'");
	Thread.sleep(1000);
	...
	js.executeScript("document.getElementById('name').value='Currently inside frame3 123456'");
	Thread.sleep(2000);
	driver.switchTo().parentFrame();
